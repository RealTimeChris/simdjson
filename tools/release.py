...
versionfilerel = os.sep + "include" + os.sep + "simdjson2" + os.sep + "simdjson2_version.h"
versionfile = maindir + versionfilerel

with open(versionfile, 'w') as file:
    file.write("// /include/simdjson2/simdjson2_version.h automatically generated by release.py,\n")
    file.write("// do not change by hand\n")
    file.write("#ifndef SIMDJSON2_SIMDJSON2_VERSION_H\n")
    file.write("#define SIMDJSON2_SIMDJSON2_VERSION_H\n")
    file.write("\n")
    file.write("/** The version of simdjson2 being used (major.minor.revision) */\n")
    file.write("#define SIMDJSON2_VERSION \""+toversionstring(*newversion)+"\"\n")
    file.write("\n")
    file.write("namespace simdjson2 {\n")
    file.write("enum {\n")
    file.write("  /**\n")
    file.write("   * The major version (MAJOR.minor.revision) of simdjson2 being used.\n")
    file.write("   */\n")
    file.write("  SIMDJSON2_VERSION_MAJOR = "+str(newversion[0])+",\n")
    file.write("  /**\n")
    file.write("   * The minor version (major.MINOR.revision) of simdjson2 being used.\n")
    file.write("   */\n")
    file.write("  SIMDJSON2_VERSION_MINOR = "+str(newversion[1])+",\n")
    file.write("  /**\n")
    file.write("   * The revision (major.minor.REVISION) of simdjson2 being used.\n")
    file.write("   */\n")
    file.write("  SIMDJSON2_VERSION_REVISION = "+str(newversion[2])+"\n")
    file.write("};\n")
    file.write("} // namespace simdjson2\n")
    file.write("\n")
    file.write("#endif // SIMDJSON2_SIMDJSON2_VERSION_H\n")
...
sonumber = None
pattern = re.compile(r"set\(SIMDJSON2_LIB_SOVERSION \"(\d+)\" CACHE STRING \"simdjson2 library soversion\"\)")
...
if(atleastminor):
    ...
    print("See https://github.com/simdjson2/simdjson2/issues/661")
    sonumber += 1
...
for line in fileinput.input(cmakefile, inplace=1, backup='.bak'):
    ...
    line = re.sub(r'SIMDJSON2_LIB_VERSION "\d+','SIMDJSON2_LIB_VERSION "'+str(sonumber), line)
    line = re.sub(r'set\(SIMDJSON2_LIB_SOVERSION \"\d+\"','set(SIMDJSON2_LIB_SOVERSION \"'+str(sonumber)+'\"', line)
    print(line)
...
pattern = re.compile(r"https://simdjson2.org/api/(\d+\.\d+\.\d+)/index.html")
