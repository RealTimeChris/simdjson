...
struct twitter_full_result {
  twitter_message result{};
  template<typename OtherStringType>
  simdjson_inline bool operator==(const twitter_full_result<OtherStringType> &other) const {
    return result == other.result;
  }
  template<typename OtherStringType>
  simdjson_inline bool operator!=(const twitter_full_result<OtherStringType> &other) const { return !(*this == other); }
};
...
template<typename I> simdjson_inline static void twitter_full(benchmark::State &state) {
