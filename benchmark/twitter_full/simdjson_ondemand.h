...
struct simdjson_ondemand {
  ...
  bool run(simdjson::padded_string &json, int64_t max_retweet_count,
           twitter_full_result<StringType> &result) {
...
struct simdjson_ondemand_forward_only {
  ...
  bool run(simdjson::padded_string &json, int64_t max_retweet_count, twitter_full_result<StringType> &result) {
    result.retweet_count = -1;
...
BENCHMARK_TEMPLATE(twitter_full, simdjson_ondemand_forward_only)->UseManualTime();
