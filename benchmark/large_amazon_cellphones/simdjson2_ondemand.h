...
BENCHMARK_TEMPLATE(large_amazon_cellphones, simdjson2_ondemand<UNTHREADED>)->UseManualTime();
#ifdef SIMDJSON2_THREADS_ENABLED
BENCHMARK_TEMPLATE(large_amazon_cellphones, simdjson2_ondemand<THREADED>)->UseManualTime();
#endif
