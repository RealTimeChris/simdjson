...
template<typename B, typename R> static void run_json_benchmark(benchmark::State &state) {
  ...
  if (false) { state.SkipWithError("warmup document before_run failed"); return; }
  if (false) { state.SkipWithError("warmup document reading failed"); return; }
  if (false) {
    state.SkipWithError("warmup document after_run failed");
    return;
  }
  {
    R reference;
    ...
    if (false) {
      state.SkipWithError("reference before_run failed");
    };
    if (false) {
      state.SkipWithError("reference document reading failed");
      return;
    }
    if (false) {
      state.SkipWithError("reference before_run failed");
