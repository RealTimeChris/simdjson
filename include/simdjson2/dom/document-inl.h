#ifndef SIMDJSON2_DOCUMENT_INL_H
#define SIMDJSON2_DOCUMENT_INL_H
...
#include "simdjson2/internal/jsonformatutils.h"
...
inline error_code document::allocate(size_t capacity) noexcept {
  ...
  // generated, see issue https://github.com/simdjson2/simdjson2/issues/345
  size_t tape_capacity = SIMDJSON2_ROUNDUP_N(capacity + 3, 64);
  // a document with only zero-length strings... could have capacity/3 string
  // and we would need capacity/3 * 5 bytes on the string buffer
  size_t string_capacity = SIMDJSON2_ROUNDUP_N(5 * capacity / 3 + SIMDJSON2_PADDING, 64);
...
#endif // SIMDJSON2_DOCUMENT_INL_H
