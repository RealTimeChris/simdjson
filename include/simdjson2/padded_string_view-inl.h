#ifndef SIMDJSON2_PADDED_STRING_VIEW_INL_H
#define SIMDJSON2_PADDED_STRING_VIEW_INL_H
...
inline std::ostream& operator<<(std::ostream& out, simdjson2_result<padded_string_view> &s) noexcept(false) { return out << s.value(); }
#endif

} // namespace simdjson2


#endif // SIMDJSON2_PADDED_STRING_VIEW_INL_H
