#ifndef SIMDJSON2_FALLBACK_NUMBERPARSING_DEFS_H
#define SIMDJSON2_FALLBACK_NUMBERPARSING_DEFS_H
...
/** @private */
static simdjson2_inline uint32_t parse_eight_digits_unrolled(const char *chars) {
  uint64_t val;
...
#endif // SIMDJSON2_FALLBACK_NUMBERPARSING_DEFS_H
