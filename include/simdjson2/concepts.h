#ifndef SIMDJSON2_CONCEPTS_H
#define SIMDJSON2_CONCEPTS_H
...
namespace details {
#define SIMDJSON2_IMPL_CONCEPT(name, method)                                    \
  template <typename T>                                                        \
...
SIMDJSON2_IMPL_CONCEPT(emplace_back, emplace_back);
SIMDJSON2_IMPL_CONCEPT(emplace, emplace);
SIMDJSON2_IMPL_CONCEPT(push_back, push_back);
SIMDJSON2_IMPL_CONCEPT(add, add);
SIMDJSON2_IMPL_CONCEPT(push, push);
SIMDJSON2_IMPL_CONCEPT(append, append);
SIMDJSON2_IMPL_CONCEPT(insert, insert);
SIMDJSON2_IMPL_CONCEPT(op_append, operator+=);

#undef SIMDJSON2_IMPL_CONCEPT
} // namespace details
