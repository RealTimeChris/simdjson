#ifndef SIMDJSON2_GENERIC_ONDEMAND_OBJECT_H

#ifndef SIMDJSON2_CONDITIONAL_INCLUDE
#define SIMDJSON2_GENERIC_ONDEMAND_OBJECT_H
...
public:
   ...
   */
  simdjson2_inline object() noexcept = default;

  simdjson2_inline simdjson2_result<object_iterator> begin() noexcept;
  simdjson2_inline simdjson2_result<object_iterator> end() noexcept;
  /**
   ...
   */
  inline simdjson2_result<value> at_pointer(std::string_view json_pointer) noexcept;
   ...
   *         - INCORRECT_TYPE if a non-integer is used to access an array
   */
  inline simdjson2_result<value> at_path(std::string_view json_path) noexcept;
   ...
   */
  inline simdjson2_result<bool> reset() & noexcept;
  /**
   ...
   * safe to continue.
   */
  inline simdjson2_result<bool> is_empty() & noexcept;
  /**
...
protected:
  ...
  static simdjson2_inline simdjson2_result<object> start(value_iterator &iter) noexcept;
  static simdjson2_inline simdjson2_result<object> start_root(value_iterator &iter) noexcept;
  static simdjson2_inline simdjson2_result<object> started(value_iterator &iter) noexcept;
  static simdjson2_inline object resume(const value_iterator &iter) noexcept;
  simdjson2_inline object(const value_iterator &iter) noexcept;

  simdjson2_warn_unused simdjson2_inline error_code find_field_raw(const std::string_view key) noexcept;

  value_iterator iter{};

  friend class value;
  friend class document;
  friend struct simdjson2_result<object>;
};
...
template<>
struct simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::object> : public SIMDJSON2_IMPLEMENTATION::implementation_simdjson2_result_base<SIMDJSON2_IMPLEMENTATION::ondemand::object> {
public:
  simdjson2_inline simdjson2_result(SIMDJSON2_IMPLEMENTATION::ondemand::object &&value) noexcept; ///< @private
  simdjson2_inline simdjson2_result(error_code error) noexcept; ///< @private
  simdjson2_inline simdjson2_result() noexcept = default;

  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::object_iterator> begin() noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::object_iterator> end() noexcept;
  ...
  inline simdjson2_result<bool> reset() noexcept;
  inline simdjson2_result<bool> is_empty() noexcept;
  inline simdjson2_result<size_t> count_fields() & noexcept;
  inline simdjson2_result<std::string_view> raw_json() noexcept;

};

} // namespace simdjson2

#endif // SIMDJSON2_GENERIC_ONDEMAND_OBJECT_H
