...
simdjson2_warn_unused simdjson2_inline error_code parser::allocate(size_t new_capacity, size_t new_max_depth) noexcept {
...
#if SIMDJSON2_DEVELOPMENT_CHECKS
simdjson2_inline simdjson2_warn_unused bool parser::string_buffer_overflow(const uint8_t *string_buf_loc) const noexcept {
  return (string_buf_loc < string_buf.get()) || (size_t(string_buf_loc - string_buf.get()) >= capacity());
}
#endif

simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(padded_string_view json) & noexcept {
...
simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate_allow_incomplete_json(padded_string_view json) & noexcept {
  if (json.padding() < SIMDJSON2_PADDING) { return INSUFFICIENT_PADDING; }
...
simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(const char *json, size_t len, size_t allocated) & noexcept {
  return iterate(padded_string_view(json, len, allocated));
}

simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(const uint8_t *json, size_t len, size_t allocated) & noexcept {
  return iterate(padded_string_view(json, len, allocated));
}

simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(std::string_view json, size_t allocated) & noexcept {
  return iterate(padded_string_view(json, allocated));
}

simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(std::string &json) & noexcept {
...
simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(const std::string &json) & noexcept {
  return iterate(padded_string_view(json));
}

simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(const simdjson2_result<padded_string_view> &result) & noexcept {
...
simdjson2_warn_unused simdjson2_inline simdjson2_result<document> parser::iterate(const simdjson2_result<padded_string> &result) & noexcept {
  // We don't presently have a way to temporarily get a const T& from a simdjson2_result<T> without throwing an exception
  SIMDJSON2_TRY( result.error() );
...
simdjson2_warn_unused simdjson2_inline simdjson2_result<json_iterator> parser::iterate_raw(padded_string_view json) & noexcept {
  if (json.padding() < SIMDJSON2_PADDING) { return INSUFFICIENT_PADDING; }
...
simdjson2_pure simdjson2_inline size_t parser::capacity() const noexcept {
  return _capacity;
}
simdjson2_pure simdjson2_inline size_t parser::max_capacity() const noexcept {
...
simdjson2_inline simdjson2_warn_unused simdjson2_result<std::string_view> parser::unescape(raw_json_string in, uint8_t *&dst, bool allow_replacement) const noexcept {
...
simdjson2_inline simdjson2_warn_unused simdjson2_result<std::string_view> parser::unescape_wobbly(raw_json_string in, uint8_t *&dst) const noexcept {
...
simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::parser>::simdjson2_result(SIMDJSON2_IMPLEMENTATION::ondemand::parser &&value) noexcept
...
simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::parser>::simdjson2_result(error_code error) noexcept
