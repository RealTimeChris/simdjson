#ifndef SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_H

#ifndef SIMDJSON2_CONDITIONAL_INCLUDE
#define SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_H
...
public:
   ...
   */
  simdjson2_inline document() noexcept = default;
  simdjson2_inline document(const document &other) noexcept = delete; // pass your documents by reference, not by copy
  simdjson2_inline document(document &&other) noexcept = default;
  simdjson2_inline document &operator=(const document &other) noexcept = delete;
  simdjson2_inline document &operator=(document &&other) noexcept = default;
   ...
   */
  simdjson2_inline simdjson2_result<array> get_array() & noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<object> get_object() & noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<uint64_t> get_uint64() noexcept;
  /**
   ...
   * @returns INCORRECT_TYPE If the JSON value is not a 64-bit unsigned integer.
   */
  simdjson2_inline simdjson2_result<uint64_t> get_uint64_in_string() noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<int64_t> get_int64() noexcept;
  /**
   ...
   * @returns INCORRECT_TYPE If the JSON value is not a 64-bit integer.
   */
  simdjson2_inline simdjson2_result<int64_t> get_int64_in_string() noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<double> get_double() noexcept;
   ...
   * @returns INCORRECT_TYPE If the JSON value is not a valid floating-point number.
   */
  simdjson2_inline simdjson2_result<double> get_double_in_string() noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<std::string_view> get_string(bool allow_replacement = false) noexcept;
  /**
  ...
  simdjson2_inline error_code get_string(string_type& receiver, bool allow_replacement = false) noexcept;
  /**
   * Cast this JSON value to a string.
   *
   ...
   * @returns INCORRECT_TYPE if the JSON value is not a string.
   */
  simdjson2_inline simdjson2_result<std::string_view> get_wobbly_string() noexcept;
  /**
   ...
   * @returns INCORRECT_TYPE if the JSON value is not a string.
   */
  simdjson2_inline simdjson2_result<raw_json_string> get_raw_json_string() noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<bool> get_bool() noexcept;
  /**
   * Cast this JSON value to a value when the document is an object or an array.
   *
   * You must not have begun iterating through the object or array. When
   * SIMDJSON2_DEVELOPMENT_CHECKS is set to 1 (which is the case when building in Debug mode
   ...
   */
  simdjson2_inline simdjson2_result<value> get_value() noexcept;
   ...
   */
  simdjson2_inline simdjson2_result<bool> is_null() noexcept;
   ...
   */
  template <typename T>
  simdjson2_inline simdjson2_result<T> get() &
...
#endif
  {
    ...
    T out{};
    SIMDJSON2_TRY(get<T>(out));
    return out;
  }
  /**
   * @overload template<typename T> simdjson2_result<T> get() & noexcept
   *
   ...
   */
  template<typename T>
  simdjson2_inline error_code get(T &out) &
#if SIMDJSON2_SUPPORTS_DESERIALIZATION
    noexcept(custom_deserializable<T, document> ? nothrow_custom_deserializable<T, document> : true)
#else
    noexcept
#endif
  {
    ...
    if constexpr (custom_deserializable<T, document>) {
      ...
      // Unless the simdjson2 library or the user provides an inline implementation, calling this method should
      // immediately fail.
      static_assert(!sizeof(T), "The get method with given type is not implemented by the simdjson2 library. "
  ...
  template<typename T> simdjson2_deprecated simdjson2_inline error_code get(T &out) && noexcept;
   ...
   *
   * See https://github.com/simdjson2/simdjson2/blob/master/doc/basics.md#adding-support-for-custom-types
   *
   * @returns An instance of type T
   */
  template <class T>
  explicit simdjson2_inline operator T() & noexcept(false);
  template <class T>
  explicit simdjson2_deprecated simdjson2_inline operator T() && noexcept(false);

  /**
   * Cast this JSON value to an array.
   *
   * @returns An object that can be used to iterate the array.
   * @exception simdjson2_error(INCORRECT_TYPE) If the JSON value is not an array.
   */
  simdjson2_inline operator array() & noexcept(false);
  /**
   * Cast this JSON value to an object.
   *
   * @returns An object that can be used to look up or iterate fields.
   * @exception simdjson2_error(INCORRECT_TYPE) If the JSON value is not an object.
   */
  simdjson2_inline operator object() & noexcept(false);
  /**
   * Cast this JSON value to an unsigned integer.
   *
   * @returns A signed 64-bit integer.
   * @exception simdjson2_error(INCORRECT_TYPE) If the JSON value is not a 64-bit unsigned integer.
   */
  simdjson2_inline operator uint64_t() noexcept(false);
  /**
   * Cast this JSON value to a signed integer.
   *
   * @returns A signed 64-bit integer.
   * @exception simdjson2_error(INCORRECT_TYPE) If the JSON value is not a 64-bit integer.
   */
  simdjson2_inline operator int64_t() noexcept(false);
  /**
   * Cast this JSON value to a double.
   *
   * @returns A double.
   * @exception simdjson2_error(INCORRECT_TYPE) If the JSON value is not a valid floating-point number.
   */
  simdjson2_inline operator double() noexcept(false);
  /**
   * Cast this JSON value to a string.
   *
   * The string is guaranteed to be valid UTF-8.
   ...
   * @returns An UTF-8 string. The string is stored in the parser and will be invalidated the next
   *          time it parses a document or when it is destroyed.
   * @exception simdjson2_error(INCORRECT_TYPE) if the JSON value is not a string.
   */
  simdjson2_inline operator std::string_view() noexcept(false);
  /**
   * Cast this JSON value to a raw_json_string.
   *
   * The string is guaranteed to be valid UTF-8, and may have escapes in it (e.g. \\ or \n).
   ...
   * @exception simdjson2_error(INCORRECT_TYPE) if the JSON value is not a string.
   */
  simdjson2_inline operator raw_json_string() noexcept(false);
  /**
   * Cast this JSON value to a bool.
   *
   * @returns A bool value.
   * @exception simdjson2_error(INCORRECT_TYPE) if the JSON value is not true or false.
   */
  simdjson2_inline operator bool() noexcept(false);
  /**
   * Cast this JSON value to a value when the document is an object or an array.
   *
   * You must not have begun iterating through the object or array. When
   * SIMDJSON2_DEVELOPMENT_CHECKS is defined, and you have already begun iterating,
   * you will get an OUT_OF_ORDER_ITERATION error. If you have begun iterating, you can use
   * rewind() to reset the document to its initial state before calling this method.
   *
   ...
   */
  simdjson2_inline operator value() noexcept(false);
#endif
  /**
   ...
   * safe to continue.
   */
  simdjson2_inline simdjson2_result<size_t> count_elements() & noexcept;
   /**
   ...
   * the is_empty() method.
   */
  simdjson2_inline simdjson2_result<size_t> count_fields() & noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<value> at(size_t index) & noexcept;
  /**
   * Begin array iteration.
   *
   * Part of the std::iterable interface.
   */
  simdjson2_inline simdjson2_result<array_iterator> begin() & noexcept;
  /**
   * Sentinel representing the end of the array.
   *
   * Part of the std::iterable interface.
   */
  simdjson2_inline simdjson2_result<array_iterator> end() & noexcept;
   ...
   * the code in Debug mode (or with the macro `SIMDJSON2_DEVELOPMENT_CHECKS` set to 1): an
   ...
   */
  simdjson2_inline simdjson2_result<value> find_field(std::string_view key) & noexcept;
  /** @overload simdjson2_inline simdjson2_result<value> find_field(std::string_view key) & noexcept; */
  simdjson2_inline simdjson2_result<value> find_field(const char *key) & noexcept;
   ...
   * @returns The value of the field, or NO_SUCH_FIELD if the field is not in the object.
   */
  simdjson2_inline simdjson2_result<value> find_field_unordered(std::string_view key) & noexcept;
  /** @overload simdjson2_inline simdjson2_result<value> find_field_unordered(std::string_view key) & noexcept; */
  simdjson2_inline simdjson2_result<value> find_field_unordered(const char *key) & noexcept;
  /** @overload simdjson2_inline simdjson2_result<value> find_field_unordered(std::string_view key) & noexcept; */
  simdjson2_inline simdjson2_result<value> operator[](std::string_view key) & noexcept;
  /** @overload simdjson2_inline simdjson2_result<value> find_field_unordered(std::string_view key) & noexcept; */
  simdjson2_inline simdjson2_result<value> operator[](const char *key) & noexcept;
   ...
   */
  simdjson2_inline simdjson2_result<json_type> type() noexcept;
   ...
   * @error TAPE_ERROR when the JSON value is a bad token like "}" "," or "alse".
   */
  simdjson2_inline simdjson2_result<bool> is_scalar() noexcept;
   ...
   * @error TAPE_ERROR when the JSON value is a bad token like "}" "," or "alse".
   */
  simdjson2_inline simdjson2_result<bool> is_string() noexcept;
   ...
   */
  simdjson2_inline bool is_negative() noexcept;
  /**
   ...
   * @returns true if the number if negative.
   */
  simdjson2_inline simdjson2_result<bool> is_integer() noexcept;
  /**
   ...
   */
  simdjson2_inline simdjson2_result<number_type> get_number_type() noexcept;

  /**
   * Attempt to parse an ondemand::number. An ondemand::number may
   * contain an integer value or a floating-point value, the simdjson2
   ...
   */
  simdjson2_warn_unused simdjson2_inline simdjson2_result<number> get_number() noexcept;
   ...
   * - null
   */
  simdjson2_inline simdjson2_result<std::string_view> raw_json_token() noexcept;
   ...
   */
  inline simdjson2_result<const char *> current_location() const noexcept;
   ...
   */
  simdjson2_inline int32_t current_depth() const noexcept;
   ...
   */
  simdjson2_inline simdjson2_result<value> at_pointer(std::string_view json_pointer) noexcept;
   ...
   *         - INCORRECT_TYPE if a non-integer is used to access an array
   */
  simdjson2_inline simdjson2_result<value> at_path(std::string_view json_path) noexcept;
   ...
   * the JSON document.
   */
  simdjson2_inline simdjson2_result<std::string_view> raw_json() noexcept;
protected:
  /**
   * Consumes the document.
   */
  simdjson2_inline error_code consume() noexcept;

  simdjson2_inline document(ondemand::json_iterator &&iter) noexcept;
  simdjson2_inline const uint8_t *text(uint32_t idx) const noexcept;

  simdjson2_inline value_iterator resume_value_iterator() noexcept;
  simdjson2_inline value_iterator get_root_value_iterator() noexcept;
  simdjson2_inline simdjson2_result<object> start_or_resume_object() noexcept;
  static simdjson2_inline document start(ondemand::json_iterator &&iter) noexcept;
...
public:
  simdjson2_inline document_reference() noexcept;
  simdjson2_inline document_reference(document &d) noexcept;
  simdjson2_inline document_reference(const document_reference &other) noexcept = default;
  simdjson2_inline document_reference& operator=(const document_reference &other) noexcept = default;
  simdjson2_inline void rewind() noexcept;
  simdjson2_inline simdjson2_result<array> get_array() & noexcept;
  simdjson2_inline simdjson2_result<object> get_object() & noexcept;
  simdjson2_inline simdjson2_result<uint64_t> get_uint64() noexcept;
  simdjson2_inline simdjson2_result<uint64_t> get_uint64_in_string() noexcept;
  ...
  /** @overload template<typename T> error_code get(T &out) & noexcept */
  template<typename T> simdjson2_inline error_code get(T &out) && noexcept;
  simdjson2_inline simdjson2_result<std::string_view> raw_json() noexcept;
  simdjson2_inline operator document&() const noexcept;
#if SIMDJSON2_EXCEPTIONS
  template <class T>
  explicit simdjson2_inline operator T() noexcept(false);
  simdjson2_inline operator array() & noexcept(false);
  ...
  simdjson2_inline simdjson2_result<const char *> current_location() noexcept;
  simdjson2_inline int32_t current_depth() const noexcept;
  simdjson2_inline bool is_negative() noexcept;
  simdjson2_inline simdjson2_result<bool> is_integer() noexcept;
  simdjson2_inline simdjson2_result<number_type> get_number_type() noexcept;
  simdjson2_inline simdjson2_result<number> get_number() noexcept;
  simdjson2_inline simdjson2_result<std::string_view> raw_json_token() noexcept;
  simdjson2_inline simdjson2_result<value> at_pointer(std::string_view json_pointer) noexcept;
  simdjson2_inline simdjson2_result<value> at_path(std::string_view json_path) noexcept;
...
template<>
struct simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::document> : public SIMDJSON2_IMPLEMENTATION::implementation_simdjson2_result_base<SIMDJSON2_IMPLEMENTATION::ondemand::document> {
public:
  simdjson2_inline simdjson2_result(SIMDJSON2_IMPLEMENTATION::ondemand::document &&value) noexcept; ///< @private
  simdjson2_inline simdjson2_result(error_code error) noexcept; ///< @private
  simdjson2_inline simdjson2_result() noexcept = default;
  simdjson2_inline error_code rewind() noexcept;

  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::array> get_array() & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::object> get_object() & noexcept;
  simdjson2_inline simdjson2_result<uint64_t> get_uint64() noexcept;
  simdjson2_inline simdjson2_result<uint64_t> get_uint64_in_string() noexcept;
  simdjson2_inline simdjson2_result<int64_t> get_int64() noexcept;
  simdjson2_inline simdjson2_result<int64_t> get_int64_in_string() noexcept;
  ...
  simdjson2_inline error_code get_string(string_type& receiver, bool allow_replacement = false) noexcept;
  simdjson2_inline simdjson2_result<std::string_view> get_wobbly_string() noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::raw_json_string> get_raw_json_string() noexcept;
  simdjson2_inline simdjson2_result<bool> get_bool() noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> get_value() noexcept;
  simdjson2_inline simdjson2_result<bool> is_null() noexcept;

  template<typename T> simdjson2_inline simdjson2_result<T> get() & noexcept;
  template<typename T> simdjson2_deprecated simdjson2_inline simdjson2_result<T> get() && noexcept;
  ...
  explicit simdjson2_inline operator T() noexcept(false);
  simdjson2_inline operator SIMDJSON2_IMPLEMENTATION::ondemand::array() & noexcept(false);
  simdjson2_inline operator SIMDJSON2_IMPLEMENTATION::ondemand::object() & noexcept(false);
  simdjson2_inline operator uint64_t() noexcept(false);
  simdjson2_inline operator int64_t() noexcept(false);
  simdjson2_inline operator double() noexcept(false);
  simdjson2_inline operator std::string_view() noexcept(false);
  simdjson2_inline operator SIMDJSON2_IMPLEMENTATION::ondemand::raw_json_string() noexcept(false);
  simdjson2_inline operator bool() noexcept(false);
  simdjson2_inline operator SIMDJSON2_IMPLEMENTATION::ondemand::value() noexcept(false);
#endif
  simdjson2_inline simdjson2_result<size_t> count_elements() & noexcept;
  simdjson2_inline simdjson2_result<size_t> count_fields() & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> at(size_t index) & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::array_iterator> begin() & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::array_iterator> end() & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> find_field(std::string_view key) & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> find_field(const char *key) & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> operator[](std::string_view key) & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> operator[](const char *key) & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> find_field_unordered(std::string_view key) & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> find_field_unordered(const char *key) & noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::json_type> type() noexcept;
  simdjson2_inline simdjson2_result<bool> is_scalar() noexcept;
  simdjson2_inline simdjson2_result<bool> is_string() noexcept;
  simdjson2_inline simdjson2_result<const char *> current_location() noexcept;
  simdjson2_inline int32_t current_depth() const noexcept;
  simdjson2_inline bool at_end() const noexcept;
  simdjson2_inline bool is_negative() noexcept;
  simdjson2_inline simdjson2_result<bool> is_integer() noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::number_type> get_number_type() noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::number> get_number() noexcept;
  /** @copydoc simdjson2_inline std::string_view document::raw_json_token() const noexcept */
  simdjson2_inline simdjson2_result<std::string_view> raw_json_token() noexcept;

  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> at_pointer(std::string_view json_pointer) noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> at_path(std::string_view json_path) noexcept;
};
...
template<>
struct simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::document_reference> : public SIMDJSON2_IMPLEMENTATION::implementation_simdjson2_result_base<SIMDJSON2_IMPLEMENTATION::ondemand::document_reference> {
public:
  simdjson2_inline simdjson2_result(SIMDJSON2_IMPLEMENTATION::ondemand::document_reference value, error_code error) noexcept;
  simdjson2_inline simdjson2_result() noexcept = default;
  simdjson2_inline error_code rewind() noexcept;
  ...
  simdjson2_inline simdjson2_result<bool> is_string() noexcept;
  simdjson2_inline simdjson2_result<const char *> current_location() noexcept;
  simdjson2_inline simdjson2_result<int32_t> current_depth() const noexcept;
  simdjson2_inline simdjson2_result<bool> is_negative() noexcept;
  simdjson2_inline simdjson2_result<bool> is_integer() noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::number_type> get_number_type() noexcept;
  simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::number> get_number() noexcept;
  /** @copydoc simdjson2_inline std::string_view document_reference::raw_json_token() const noexcept */
  simdjson2_inline simdjson2_result<std::string_view> raw_json_token() noexcept;
...
#endif // SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_H
