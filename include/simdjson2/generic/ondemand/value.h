#ifndef SIMDJSON2_GENERIC_ONDEMAND_VALUE_H

#ifndef SIMDJSON2_CONDITIONAL_INCLUDE
#define SIMDJSON2_GENERIC_ONDEMAND_VALUE_H
...
public:
   ...
   */
  simdjson2_inline value() noexcept = default;
...
#endif
 {
   ...
   */
  simdjson2_inline std::string_view raw_json_token() noexcept;
   ...
   *         - INCORRECT_TYPE if a non-integer is used to access an array
   */
  simdjson2_inline simdjson2_result<value> at_path(std::string_view at_path) noexcept;
...
protected:
   ...
   * Create a value.
   */
  simdjson2_inline value(const value_iterator &iter) noexcept;

  /**
   * Skip this value, allowing iteration to continue.
   */
  simdjson2_inline void skip() noexcept;
   ...
   */
  static simdjson2_inline value start(const value_iterator &iter) noexcept;

  /**
   * Resume a value.
   */
  static simdjson2_inline value resume(const value_iterator &iter) noexcept;
  ...
  // simdjson2_inline void log_error(const char *message) const noexcept;
  ...
  friend class field;
  friend class object;
  friend struct simdjson2_result<value>;
...
template<>
struct simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> : public SIMDJSON2_IMPLEMENTATION::implementation_simdjson2_result_base<SIMDJSON2_IMPLEMENTATION::ondemand::value> {
public:
  simdjson2_inline simdjson2_result(SIMDJSON2_IMPLEMENTATION::ondemand::value &&value) noexcept; ///< @private
  ...
  /** @overload simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> find_field(std::string_view key) noexcept; */
  ...
  /** @overload simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::value> find_field_unordered(std::string_view key) noexcept; */
  ...
  /** @copydoc simdjson2_inline std::string_view value::raw_json_token() const noexcept */
  simdjson2_inline simdjson2_result<std::string_view> raw_json_token() noexcept;
  simdjson2_inline simdjson2_result<std::string_view> raw_json() noexcept;

  /** @copydoc simdjson2_inline simdjson2_result<const char *> current_location() noexcept */
  simdjson2_inline simdjson2_result<const char *> current_location() noexcept;
  /** @copydoc simdjson2_inline int32_t current_depth() const noexcept */
...
#endif // SIMDJSON2_GENERIC_ONDEMAND_VALUE_H
