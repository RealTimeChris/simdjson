#ifndef SIMDJSON2_GENERIC_ONDEMAND_ARRAY_H

#ifndef SIMDJSON2_CONDITIONAL_INCLUDE
#define SIMDJSON2_GENERIC_ONDEMAND_ARRAY_H
...
public:
   ...
   */
  simdjson2_inline array() noexcept = default;
   ...
   * safe to continue.
   */
  simdjson2_inline simdjson2_result<bool> is_empty() & noexcept;
  /**
...
protected:
   ...
   */
  static simdjson2_inline simdjson2_result<array> start(value_iterator &iter) noexcept;
  /**
   ...
   */
  static simdjson2_inline simdjson2_result<array> start_root(value_iterator &iter) noexcept;
  /**
   * Begin array iteration.
   *
   ...
   */
  static simdjson2_inline simdjson2_result<array> started(value_iterator &iter) noexcept;
   ...
   */
  simdjson2_inline array(const value_iterator &iter) noexcept;
  ...
  friend struct simdjson2_result<array>;
...
template<>
struct simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::array> : public SIMDJSON2_IMPLEMENTATION::implementation_simdjson2_result_base<SIMDJSON2_IMPLEMENTATION::ondemand::array> {
public:
  simdjson2_inline simdjson2_result(SIMDJSON2_IMPLEMENTATION::ondemand::array &&value) noexcept; ///< @private
  ...
  inline simdjson2_result<size_t> count_elements() & noexcept;
...
#endif // SIMDJSON2_GENERIC_ONDEMAND_ARRAY_H
