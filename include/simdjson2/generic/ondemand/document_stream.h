#ifndef SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_STREAM_H

#ifndef SIMDJSON2_CONDITIONAL_INCLUDE
#define SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_STREAM_H
...
public:
  ...
  class iterator {
  public:
    using value_type = simdjson2_result<document>;
    using reference  = simdjson2_result<ondemand::document_reference>;
    using pointer    = void;
...
private:
  ...
  friend class document;
  friend class json_iterator;
  friend struct simdjson2_result<ondemand::document_stream>;
  friend struct simdjson2::internal::simdjson2_result_base<ondemand::document_stream>;
};  // document_stream
...
#endif // SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_STREAM_H
