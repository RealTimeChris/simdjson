#ifndef SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_STREAM_INL_H

#ifndef SIMDJSON2_CONDITIONAL_INCLUDE
#define SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_STREAM_INL_H
...
simdjson2_inline simdjson2_result<ondemand::document_reference> document_stream::iterator::operator*() noexcept {
  return simdjson2_result<ondemand::document_reference>(stream->doc, stream->error);
}
...
simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::document_stream>::simdjson2_result(
  error_code error
) noexcept :
    implementation_simdjson2_result_base<SIMDJSON2_IMPLEMENTATION::ondemand::document_stream>(error)
{
}
simdjson2_inline simdjson2_result<SIMDJSON2_IMPLEMENTATION::ondemand::document_stream>::simdjson2_result(
  SIMDJSON2_IMPLEMENTATION::ondemand::document_stream &&value
) noexcept :
    implementation_simdjson2_result_base<SIMDJSON2_IMPLEMENTATION::ondemand::document_stream>(
      std::forward<SIMDJSON2_IMPLEMENTATION::ondemand::document_stream>(value)
    )
{
}
...
#endif // SIMDJSON2_GENERIC_ONDEMAND_DOCUMENT_STREAM_INL_H