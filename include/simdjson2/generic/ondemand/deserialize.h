...
#ifndef SIMDJSON2_ONDEMAND_DESERIALIZE_H
#ifndef SIMDJSON2_CONDITIONAL_INCLUDE
#define SIMDJSON2_ONDEMAND_DESERIALIZE_H
...
template <> struct is_builtin_deserializable<SIMDJSON2_IMPLEMENTATION::ondemand::array> : std::true_type {};
template <> struct is_builtin_deserializable<SIMDJSON2_IMPLEMENTATION::ondemand::object> : std::true_type {};
template <> struct is_builtin_deserializable<SIMDJSON2_IMPLEMENTATION::ondemand::value> : std::true_type {};
template <> struct is_builtin_deserializable<SIMDJSON2_IMPLEMENTATION::ondemand::raw_json_string> : std::true_type {};
...
template <typename T, typename ValT = SIMDJSON2_IMPLEMENTATION::ondemand::value>
...
inline constexpr struct deserialize_tag {
  using value_type = SIMDJSON2_IMPLEMENTATION::ondemand::value;
  using document_type = SIMDJSON2_IMPLEMENTATION::ondemand::document;
  using document_reference_type = SIMDJSON2_IMPLEMENTATION::ondemand::document_reference;
...
#endif // SIMDJSON2_ONDEMAND_DESERIALIZE_H
