#ifndef SIMDJSON2_PADDED_STRING_VIEW_H
#define SIMDJSON2_PADDED_STRING_VIEW_H

#include "simdjson2/portability.h"
#include "simdjson2/base.h" // for SIMDJSON2_PADDING
...
public:
  ...
  /**
   * Promise the given buffer has at least SIMDJSON2_PADDING extra bytes allocated to it.
   *
   * @param s The string.
...
#endif
  /**
   * Promise the given string has at least SIMDJSON2_PADDING extra bytes allocated to it.
   *
  ...
  /**
   * Promise the given string_view has at least SIMDJSON2_PADDING extra bytes allocated to it.
   *
   * @param s The string.
   * @param capacity The allocated length of the string, including padding. If the capacity is less
   *      than the length, the capacity will be set to the length.
 ...
 *        thrown).
 */
inline std::ostream& operator<<(std::ostream& out, simdjson2_result<padded_string_view> &s) noexcept(false);
#endif

} // namespace simdjson2

#endif // SIMDJSON2_PADDED_STRING_VIEW_H
